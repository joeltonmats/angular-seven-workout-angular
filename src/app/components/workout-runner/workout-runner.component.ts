import { Component, OnInit, OnDestroy, Output, EventEmitter, Input, DoCheck } from '@angular/core';
...
export class WorkoutRunnerComponent implements OnInit, DoCheck, OnDestroy {
    ...
    ngOnInit() {
        console.log('this.workoutName: ', this.workoutName);
    ...
    getWorkout(name: string) {
        console.log("name in getWorkout()", name);
